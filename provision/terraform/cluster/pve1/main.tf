...
data "local_file" "public_key" {
  filename = data.sops_file.cluster_secrets.data["pve1_ssh_pub_key_file"]
}
...
provider "proxmox" {
  pm_api_url          = data.sops_file.cluster_secrets.data["pve1_proxmox_url"]
  pm_api_token_id     = data.sops_file.cluster_secrets.data["pve1_proxmox_api_token_id"]
  pm_api_token_secret = data.sops_file.cluster_secrets.data["pve1_proxmox_api_token_secret"]
  pm_parallel         = 2
  pm_timeout          = 600
